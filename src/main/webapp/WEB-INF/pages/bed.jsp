...
$(function(){//jquery的加载事件
	$('#table').bootstrapTable({
		  url: '${pageContext.request.contextPath}/bed/queryBedUserIcu',//访问后台（json）的地址
	...
	$.ajax({
		type:'post',//提交方式
		url:'${pageContext.request.contextPath}/user/getUser',//访问后台的地址   查询所有的医师信息
	...
	$.ajax({
		type:'post',//提交方式
		url:'${pageContext.request.contextPath}/queryIcu',//访问后台的地址   查询所有的医师信息
		async:false,//  true：异步     false:同步
		dataType: "json",//数据类型
		success: function(data){
...
<!--修改-->
  function myUpdateClick(bednumber){
  	...
  	$.ajax({
  		 type:"post",//请求方式
  		 url:"${pageContext.request.contextPath}/bed/updateBed",//根据编号查询用户的信息
  ...
  function updateBed(){
		...
		$.ajax({
			type:'post',//提交方式
			url:'${pageContext.request.contextPath}/bed/saveBed',//修改的地址
			data:data,
			dataType:'json',
			success:function(data){
			alert("修改完成")
...
//添加事件
  ...
  function addBed() {
    	...
    	$.ajax({
  		type:'post',//提交方式
  		url:'${pageContext.request.contextPath}/bed/addBed',//修改的地址
  		data:data,
  		dataType:'json',
  		success:function(data){
  			alert("添加完成");

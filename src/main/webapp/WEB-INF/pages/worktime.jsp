...
<script type="text/javascript">
  $(function(){
	  $('#table').bootstrapTable({
		  url: '${pageContext.request.contextPath}/worktime/queryWorkTime',//访问后台（json）的地址
...
function myUpdateClick(id) {
	...
	$.ajax({
		 type:"post",//请求方式
		 url:"${pageContext.request.contextPath}/worktime/getWorktimeById",
		 data:{wkid:id},//传参数到后台
...
function updateWorktime() {
	...
	$.ajax({
		 type:"post",//请求方式
		 url:"${pageContext.request.contextPath}/worktime/updateWorkTimeById",//根据编号查询用户的信息
		 data:{
			 wkid:wkid,
			 worktime:worktime,
...
function addWorktime() {
	...
	if(worktime==null||departmentid==null||userid==null||worktime==''){
		...
		//ajax提交数据
		 $.ajax({
		 type:"post",//请求方式
		 url:"${pageContext.request.contextPath}/worktime/addWorktime",//根据编号查询用户的信息
		 data:{
			 worktime:worktime,
			 departmentid:departmentid,
			 userid:userid

...
$(function(){//jquery的加载事件
	$('#table').bootstrapTable({
		  url: '${pageContext.request.contextPath}/inpatient/queryInpatientDepartment',//访问后台（json）的地址
	...
	$.ajax({
		type:'post',//提交方式
		url:'${pageContext.request.contextPath}/queryPatient',//访问后台的地址   查询所有的病人信息
		async:false,//  true：异步     false:同步
		dataType: "json",//数据类型
		success: function(data){
	...
	$.ajax({
		type:'post',//提交方式
		url:'${pageContext.request.contextPath}/bed/queryBed',//访问后台的地址   查询所有的病人信息
		async:false,//  true：异步     false:同步
		dataType: "json",//数据类型
		success: function(data){
 ...
 <!--修改-->
  function myUpdateClick(hospitalizationid){
  	...
  	$.ajax({
  		 type:"post",//请求方式
  		 url:"${pageContext.request.contextPath}/inpatient/updateInpatient",//根据编号查询用户的信息
  ...
  function updateInpatient(){
		...
		$.ajax({
			type:'post',//提交方式
			url:'${pageContext.request.contextPath}/inpatient/saveInpatient',//修改的地址
			data:data,
			dataType:'json',
			success:function(data){
			alert("修改完成")
...
//添加事件
  ...
  function addInpatient() {
    	...
    	$.ajax({
  		type:'post',//提交方式
  		url:'${pageContext.request.contextPath}/inpatient/addInpatient',//修改的地址
  		data:data,
  		dataType:'json',
  		success:function(data){
  			alert("添加完成");

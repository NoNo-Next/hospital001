...
<script type="text/javascript">
  $(function(){
	  $('#table').bootstrapTable({
		  url: '${pageContext.request.contextPath}/icu/queryIcu',//访问后台（json）的地址
...
function myUpdateClick(id) {
	...
	$.ajax({
		 type:"post",//请求方式
		 url:"${pageContext.request.contextPath}/icu/getIcuById",
...
function updateIcu() {
	...
	$.ajax({
		 type:"post",//请求方式
		 url:"${pageContext.request.contextPath}/icu/updateIcuById",//根据编号查询用户的信息
		 data:data,//传参数到后台
		 dataType:"json",//以json格式传递数据
		 success:function(data){
...
function myDeleteClick(id) {
	...
	$.ajax({
		 type:"post",//请求方式
		 url:"${pageContext.request.contextPath}/icu/deleteById",//根据编号查询用户的信息
		 data:{icuid:id},//传参数到后台
		 dataType:"json",//以json格式传递数据
		 success:function(data){
			  //刷新页面
...
function addIcu() {
	...
	if( name==null||name==''){
		...
		//ajax提交数据
		 $.ajax({
		 type:"post",//请求方式
		 url:"${pageContext.request.contextPath}/icu/addIcu",//根据编号查询用户的信息
		 data:data,//传参数到后台
		 dataType:"json",//以json格式传递数据
		 success:function(data){
			  //刷新页面

...
<script type="text/javascript">
  $(function(){
	  $('#table').bootstrapTable({
		  url: '${pageContext.request.contextPath}/department/queryDepartment',//访问后台（json）的地址
...
function myDeleteClick(id) {
	if(confirm("确定要删除么？？？")){
		...
		$.ajax({
			type:"post",//请求方式
			url:"${pageContext.request.contextPath}/department/deleteById",//根据编号查询用户的信息
...
function addDepartment() {
	...
	if(departmentname==null||departmentaddress==null||departmenttelephone==null||userid==null||departmentname==''||departmentaddress==''||departmenttelephone==''||userid==''){
		...
		//ajax提交数据
		 $.ajax({
		 type:"post",//请求方式
		 url:"${pageContext.request.contextPath}/department/addDepartment",//根据编号查询用户的信息
		 data:{
...
function myUpdateClick(id) {
	...
	$.ajax({
		 type:"post",//请求方式
		 url:"${pageContext.request.contextPath}/department/getDepartmentById",//根据编号查询用户的信息
...
function updateDepartment() {
	...
	$.ajax({
		 type:"post",//请求方式
		 url:"${pageContext.request.contextPath}/department/updateDepartmentById",//根据编号查询用户的信息
		 data:data,//传参数到后台
		 dataType:"json",//以json格式传递数据
		 success:function(data){
			 //alert("cgg");

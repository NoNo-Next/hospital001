...
<script type="text/javascript">
    $(function () {
        $('#table').bootstrapTable({
            url: '${pageContext.request.contextPath}/register/queryRegister',//访问后台（json）的地址
            pagination: true,//允许分页
            search: true,//可以搜索
            toolbar: "#toolbar",
            pageSize: 5,//每页显示3条数据
            pageList: [5, 6, 7, 8, 9],//每页显示的条数列表
        ...
        $.ajax({
            type: 'post',//提交方式
            url: '${pageContext.request.contextPath}/user/getUser',//访问后台的地址   查询所有的岗位信息
            async: false,//  true：异步     false:同步
            dataType: "json",//数据类型
            success: function (data) {
        ...
        $.ajax({
            type: 'post',//提交方式
            url: '${pageContext.request.contextPath}/patient/queryPatient',//访问后台的地址   查询所有的岗位信息
            async: false,//  true：异步     false:同步
            dataType: "json",//数据类型
            success: function (data) {
    ...
    function myDeleteClick(id) {
        ...
        $.ajax({
            type: "post",//请求方式
            url: "${pageContext.request.contextPath}/registrationorder/deleteById",//根据编号查询用户的信息
    ...
    function myUpdateClick(registerid) {
        ...
        $.ajax({
            type: "post",//请求方式
            url: "${pageContext.request.contextPath}/registrationorder/getById",//根据编号查询用户的信息
    ...
    function updateRegistrationorder() {
        ...
        $.ajax({
            type: 'post',//提交方式
            url: '${pageContext.request.contextPath}/registrationorder/saveUpdateRegistrationorder',//修改的地址
            data: data,
            dataType: 'json',
            success: function (data) {
                if (data == 1) {
    ...
    function addRegistrationorder() {
        ...
        $.ajax({
            type: 'post',//提交方式
            url: '${pageContext.request.contextPath}/registrationorder/addRegistrationorder',//修改的地址
            data: data,
            dataType: 'json',
            success: function (data) {
            ...
            <div class="modal-body">
                <form id="myAddForm" class="form-horizontal" action="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="registrationdate" id="registrationdate"
                                   placeholder="(非必填项)">
                            <label id="registrationdate-error" class="error" for="registrationdate"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control" name="registeredfee" id="registeredfee"
                                   placeholder="(必填项)">
                            <label id="registeredfee-error" class="error" for="registeredfee"
                                   style="margin-top: 4px;color: red;font-size: 15px;"></label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            ...
                            <input type="hidden" class="form-control" name="physicianincharge" id="physicianincharge"
                                   value="1">
                            <label id="physicianincharge-error" class="error" for="physicianincharge"
                                   style="margin-top: 4px;color: red;font-size: 15px;"></label>
                ...
                <form id="myUpdateForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            ...
                            <label id="registrationdate-error1" class="error" for="registrationdate"
                                   style="margin-top: 4px;color: red;font-size: 15px;"></label>
                            <script src="${pageContext.request.contextPath}/plugin/layDate-v5.0.9/laydate/laydate.js"></script>
                            <script>
                                laydate.render({

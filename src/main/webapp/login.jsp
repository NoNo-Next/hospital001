...
<body>
<div class="login">
    <div class="message">晨轩医院管理系统</div>
    ...
    <form method="post" action="#">
		...
		<hr class="hr15">
		<img id="imgObj" alt="" src="${pageContext.request.contextPath}/kaptcha" title="看不清，点击刷新">
		<hr class="hr15">
...
<script type="text/javascript">
   $(function(){//jquery加载事件  text()、attr()、val()、html()
	   ...
	   $("#imgObj").click(function(){
		   $(this).attr("src","${pageContext.request.contextPath}/kaptcha");
	   })
   })
   function login(){
